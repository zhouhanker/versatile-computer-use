...
更新：2026-09-26。作者：本机真机记录。状态：会话点击、1+1、12+7、记忆、科学模式、对数、sin(30°) 和 cos(0) 已复测。不是完整 Windows 产品 CU，也没有新的 GitHub Release。
...
- 科学模式验证了切换、π、log10(100)、ln(e)、sin(30°) 和 cos(0)。没有覆盖正切和弧度模式。
