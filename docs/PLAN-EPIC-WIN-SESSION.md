...
更新：2026-09-26。作者：本机真机记录。状态：会话点击、1+1、12+7、记忆、科学模式、对数、sin、cos 和 tan 已复测。不是完整 Windows 产品 CU，也没有新的 GitHub Release。
...
- 科学模式验证了切换、π、log10(100)、ln(e)、sin(30°)、cos(0) 和 tan(45°)。没有覆盖弧度模式。
