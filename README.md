...
已发布的是浏览器 Bridge 0.2.8，加上允许名单内的桌面切片。这不是完整 Codex Computer Use，也不是完整 Windows 产品 CU。Windows 产品会话证据到 CU-WIN-SESSION-068。
